...
public interface JpaConst {
    ...
    //いいねの数
    String Q_FAV_GET_ALL_MINE = ENTITY_REP + ".getAllMine";
    String Q_FAV_GET_ALL_MINE_DEF = "SELECT f FROM Favorite AS f WHERE f.report = :" + JPQL_PARM_EMPLOYEE + " ORDER BY r.id DESC";
